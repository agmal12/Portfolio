    ...
    <AnimatePresence>
      ...
      >
        ...
        >
          ...
          <button
            onClick={closeModal}
            className="absolute top-4 right-4 p-2 rounded-full bg-midnight/80 hover:bg-gray-700 transition-colors z-20"
          ...
          <div className="p-6 sm:p-8">
            ...
            <div className="flex flex-col items-start justify-between gap-6 mt-8 sm:flex-row sm:items-center">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 px-6 py-3 font-medium text-white transition-colors rounded-lg bg-indigo-600 hover:bg-indigo-700"
              >
                View Project
                <svg
                  xmlns="http://www.w3.org/2000/svg"
